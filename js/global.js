...
$(document).ready(function() {
	...
	*/
	...
	$("#about .recents .rollover").append("<span></span>");
	$("#about .recents .rollover").hover(function(){
		$(this).children("span").stop(true, true).fadeIn(600);
	},function(){
		$(this).children("span").stop(true, true).fadeOut(200);
	});
	...
	//ABOUT - SCROLL TEXT
	$('#about .scroll-text').mCustomScrollbar();
	
	
	//PORTFOLIO - CATEGORIES ZOOM ICON
	$("#portfolio .rollover").append("<span></span>");
	$("#portfolio .rollover").hover(function(){
		$(this).children("span").stop(true, true).fadeIn(600);
	},function(){
		$(this).children("span").stop(true, true).fadeOut(200);
	});
	...
	function openContent(e) {
		...
		if (id !== 'link' && activeItem !== clickedItem) {
			...
			if (section == '#about') $('#about .scroll-text').mCustomScrollbar("update");
		}
